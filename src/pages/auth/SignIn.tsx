...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent px-4">
      <AnimatedDiv
        className="w-full max-w-sm gap-4 shadow-lg py-5"
        delay={0.5}
        ...
        <Card>
          ...
          <CardContent>
            <Form {...form}>
              ...
              >
                {isSignInError && (
                  <div className="w-full bg-red-200 py-2 px-5 rounded-sm text-red-600 text-sm">
                    Invalid Credentials
                  </div>
                )}
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs text-[#202224]">
                        Email address:
                      </FormLabel>
                      <FormControl>
                        <Input
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex justify-between items-center">
                        <FormLabel className="text-xs text-t-202224">
                          Password
                        </FormLabel>
                        <button
                          type="button"
